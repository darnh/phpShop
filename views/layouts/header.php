...
<html data-wf-domain="biznus-template.webflow.io" data-wf-page="5e7ff3ec0c4ef46264fa99e4"
      data-wf-site="5e7ff3ec0c4ef4c974fa99e3" data-wf-status="1"
      class="w-mod-js wf-sen-n4-active wf-sen-n7-active wf-sen-n8-active wf-active">
<header>
    <meta charset="utf-8">
    <title>Biznus Template - Webflow Ecommerce Website Template</title>
                ...
                <div class="nav-wrapper"><a href="/" aria-current="page" class="brand w-nav-brand w--current"><img
                    ...
                    <div class="cart-nav-wrapper">
                        <nav role="navigation" class="nav-menu w-nav-menu"><a href="/" aria-current="page"
                                                                              class="nav-link w-nav-link w--current">Home</a><a
                                href="/contact" class="nav-link w-nav-link">About</a><a href="/catalog"
                                                                                               class="nav-link w-nav-link">Catalog</a>

                            <a href="/user/register" class="nav-link w-nav-link">Account login</a>

                            <?php if (User::isGuest()): ?>
                            <a href="/cabinet/" class="nav-link w-nav-link">Cabinet</a>
                            <?php else: ?>
                            <a href="/user/login/"    class="nav-link w-nav-link">Log in</a>  <a href="/user/logout/"
                                                                                               class="nav-link w-nav-link">Logout</a>
                            <?php endif; ?>
                        </nav>

                        <div>
                            <div data-node-type="commerce-cart-wrapper" data-open-product=""
                                 data-wf-cart-type="rightSidebar" data-wf-cart-query="query Dynamo2 {
  database {
    id
    commerceOrder {
      comment
...
" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper cart-menu"><a href="/cart/"
                                                                                       data-node-type="commerce-cart-open-link"
                                                                                       class="w-commerce-commercecartopenlink cart w-inline-block"
                                                                                       role="button"
                                                                                       aria-haspopup="dialog"
                                                                                       aria-label="Open cart"> <span id="cart-count">(<?php echo Cart::countItems(); ?>)</span><img
                                    ...
                                    <div data-wf-bindings="%5B%7B%22innerHTML%22%3A%7B%22type%22%3A%22Number%22%2C%22filter%22%3A%7B%22type%22%3A%22numberPrecision%22%2C%22params%22%3A%5B%220%22%2C%22numberPrecision%22%5D%7D%2C%22dataPath%22%3A%22database.commerceOrder.userItemsCount%22%7D%7D%5D"
                                         class="w-commerce-commercecartopenlinkcount cart-quantity-cart">0
                                    </div>
                                </a>
                            </div>
                        </div>
